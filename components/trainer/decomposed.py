...
from components.utils import DEVICE
...
class VitDecomposedTrainer(BaseTrainer):
    ...
    def rearrange_outputs(
        self, class_wise_logits: dict[str, TransformerData], num_outputs
    ):
        # y_pred, y_true
    ...
    def get_outputs(self, model_inputs, **kwargs) -> tuple[list, dict]:
        ...
        y_pred, y_true = self.rearrange_outputs(class_wise_logits, num_outputs)
